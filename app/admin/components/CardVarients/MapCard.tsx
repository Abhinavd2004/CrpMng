...
import { plotType } from "../../utils/types";
...
export const MapCardClient = () => {
  ...
  const selectedCropPlot: plotType[] = Plots.filter((area) =>
  ...
  useEffect(
    () => console.log(selectedCrop, validLocations, currentLocation),
    [selectedCrop],
  );
  useEffect(() => console.log(currentLocation), [currentLocation]);
  useEffect(() => console.log(selectedPlot), [selectedPlot]);
